...
SECRET_KEY = 'django-insecure-8)3q8zut*7lp&me@@-fl$pp1uty9tdny*yxote(d#n5eqx8875'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'ranking.pythonanywhere.com']
...
# 静的ファイルが格納されるディレクトリへのパスを指定します。
# 通常はプロジェクトのルートディレクトリからの相対パスとなります。
